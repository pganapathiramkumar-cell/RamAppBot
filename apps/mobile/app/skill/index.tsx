    ...
    <ThemedView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          ...
          <ThemedText type="title" style={styles.title}>Skill</ThemedText>
          <ThemedText style={styles.subtitle}>AI Capability Catalog</ThemedText>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardDesc}>
            The Skill module lets you build and manage your enterprise AI capability
            catalog — from draft through review, approval and deployment — with
            AI-powered tagging and quality evaluation.
          </Text>
          <View style={styles.featureList}>
            {[
              '🧠  AI capability catalog (NLP, Vision, RAG, Agents…)',
              '🏷️  AI auto-tagging via Llama 3.2',
              '⭐  Quality scoring (accuracy + latency)',
              '🔄  DRAFT → REVIEW → APPROVED → DEPLOYED lifecycle',
              '🔍  Skill gap analysis against Steer goals',
            ].map((f) => (
